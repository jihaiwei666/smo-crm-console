...
class UpdateContractBasicInfo extends React.Component<UpdateContractBasicInfoProps> {
  ...
  componentWillReceiveProps(nextProps: UpdateContractBasicInfoProps) {
  ...
  render() {
    return (
      <Form onValidChange={valid => this.setState({valid})}>
        ...
        <div className="bb">
          <LabelAndInput label="是否首次合作" disabled={true} placeholder="尚未确定" value={this.state.isFirstOperation ? '是' : '否'}/>
...
})(addCommonFunction(UpdateContractBasicInfo))
